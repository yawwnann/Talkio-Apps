...
class LatihanArtikulasiData {
  ...
  static const List<Map<String, String>> items = [
    // Target 'R'
    {
      ...
      'emoji': '🧱',
      'target': 'R',
      'tip': 'Gulungkan lidah ke atas, rrrr!',
    },
    {
      'id': 'rumah',
      'word': 'Rumah',
      'emoji': '🏠',
      'target': 'R',
      'tip': 'TEKAN huruf R, seperti geraman',
    },
    {
      'id': 'roti',
      'word': 'Roti',
    ...
    // Target 'S'
    {
      ...
      'emoji': '👟',
      'target': 'S',
      'tip': 'Sssss... jangan pakai gigi bawah dulu',
    },
    {
      'id': 'sarung',
      'word': 'Sarung',
      'emoji': '🧣',
      'target': 'S',
      'tip': 'Saa-rung, ujung lidah di atas gigi',
    },
    {
      'id': 'sapi',
      'word': 'Sapi',
    ...
    // Target 'L'
    {
      ...
      'emoji': '💡',
      'target': 'L',
      'tip': 'Lam-pu, ujung lidah tekan gigi atas',
    },
    {
      'id': 'lipat',
      'word': 'Lipat',
